// Small synchronous SHA-256 implementation for deterministic local-storage keys.
// Web Crypto is asynchronous, while finding visibility is queried during rendering.
const constants = [
